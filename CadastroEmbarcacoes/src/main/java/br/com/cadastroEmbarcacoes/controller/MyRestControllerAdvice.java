...
import br.com.cadastroEmbarcacoes.exception.Error;
import br.com.cadastroEmbarcacoes.exception.NotFoundException;
import br.com.cadastroEmbarcacoes.exception.PropertyError;
import br.com.cadastroEmbarcacoes.exception.ValidationError;
...
public class MyRestControllerAdvice {
    ...
    public ResponseEntity erroPadrão(NotFoundException e, HttpServletRequest request){
    ...
    public ResponseEntity erroPadrão(Exception e, HttpServletRequest request){
        Error erro = new Error(
                Calendar.getInstance(), 
